...
import { faBars, faEllipsisV, faHamburger } from "@fortawesome/free-solid-svg-icons";
...
function Nav(
  ...
  <div className = "">
    <nav className={`flex flex-wrap items-center justify-between p-5`}>
      ...
      <div className={`sm:flex sm:items-center sm:w-auto w-full z-0 ${menuHidden && 'hidden'}`}>
